...
export type VideoCover = { kind: "video"; poster: string; mp4: string; webm?: string };
export type ImageCover = { kind: "image"; src: string; alt: string; bg?: string };
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    featured: true, // <- featured #2
    cover: { kind: "image", src: "/images/bd2m_logo12.png", alt: "BestDay2Marry Logo", bg: "bg-neutral-100" },
  },
  {
    ...
    tags: ["Design", "Next.js"],
    featured: true, // <- featured #3
    cover: { kind: "image", src: "/images/climformatics_inc_logo.jpeg", alt: "Climformatics logo", bg: "bg-white" },
  },

  // ...add the rest of your non-featured projects here (no featured flag or set to false)
];